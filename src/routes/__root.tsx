  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Beginner-friendly GenAI Engineer interview handbook for junior roles in India MNCs. Learn LLMs, RAG, agents, fine-tuning, and production.",
      },
      { name: "theme-color", content: "#243D36" },
    ],
    links: [
